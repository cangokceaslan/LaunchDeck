...
export const ReleasePipeline = ({
  ...
  return (
    <div className={styles.page}>
      ...
      <section className={`${styles.wizardCard} ${isRunStarted ? styles.runningWizardCard : ''}`}>
        {step === 1 && (
